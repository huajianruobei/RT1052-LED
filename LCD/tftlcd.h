...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------MCU屏 LCD端口定义---------------- 
#define LCD_LED(n) (n?GPIO_PinWrite(GPIO3,2,1):GPIO_PinWrite(GPIO3,2,0)) 
...
#define DBI_START_ADDR  ((u32)(0X9C000000)) 				//DBI开始地址(默认地址) 
#define DBI_SIZE_KBYTES ((u32)(64*1024))                    //DBI大小，单位kBytes(默认32MB)
#define LCD_BASE        ((u32)(0X9C000000 | 0X0FFFE))		//地址＜0X10000,是读/写数据,地址≥0X10000是读/写指令,注意:最低位不能为1
